...
alias com {
  ...
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/ADC_driver_modular_adc_0_avalon_st_adapter_001_timing_adapter_1.sv"      -work timing_adapter_1                
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/ADC_driver_modular_adc_0_avalon_st_adapter_001_timing_adapter_0.sv"      -work timing_adapter_0                
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/ADC_driver_modular_adc_0_avalon_st_adapter_001_data_format_adapter_0.sv" -work data_format_adapter_0           
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/ADC_driver_modular_adc_0_avalon_st_adapter_timing_adapter_1.sv"          -work timing_adapter_1                
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/ADC_driver_modular_adc_0_avalon_st_adapter_timing_adapter_0.sv"          -work timing_adapter_0                
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/ADC_driver_modular_adc_0_avalon_st_adapter_data_format_adapter_0.sv"     -work data_format_adapter_0           
  ...
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/ADC_driver_modular_adc_0_avalon_st_adapter_001.v"                        -work avalon_st_adapter_001           
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/ADC_driver_modular_adc_0_avalon_st_adapter.v"                            -work avalon_st_adapter               
  ...
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/ADC_driver_modular_adc_0_adc_monitor_internal.v"                         -work adc_monitor_internal            
  ...
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/ADC_driver_modular_adc_0.v"                                              -work modular_adc_0                   
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/ADC_driver.v"                                                                                                             
}
